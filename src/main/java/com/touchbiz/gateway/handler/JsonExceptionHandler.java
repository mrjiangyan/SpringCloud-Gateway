 ...
 */
package com.touchbiz.gateway.handler;
...
public class JsonExceptionHandler implements ErrorWebExceptionHandler {
     ...
     */
    private final List<HttpMessageReader<?>> messageReaderList;
    /**
     ...
     */
    private final List<HttpMessageWriter<?>> messageWriterList;
    /**
     * 视图解析器
     */
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        String msg;
        ApiResult  apiResult = ApiResult.getErrorResponse(ex);
     ...
     * 存储当前线程异常信息
     */
    private final ThreadLocal<Map<String, Object>> resultThreadLocal = new ThreadLocal<>();
    /**
     * 请求状态
     */
