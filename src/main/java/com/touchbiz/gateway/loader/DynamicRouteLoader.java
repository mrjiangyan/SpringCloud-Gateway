package com.touchbiz.gateway.loader;
...
import com.touchbiz.gateway.config.GatewayRoutersConfig;
import com.touchbiz.gateway.config.RouterDataType;
import com.touchbiz.gateway.constant.CacheConstant;
import com.touchbiz.gateway.loader.repository.DynamicRouteService;
import com.touchbiz.gateway.loader.repository.MyInMemoryRouteDefinitionRepository;
import com.touchbiz.gateway.loader.vo.MyRouteDefinition;
...
public class DynamicRouteLoader implements ApplicationEventPublisherAware {
    ...
    private final MyInMemoryRouteDefinitionRepository repository;
    ...
    private void loadRoutesByNacos() {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(configInfo)) {
                log.info("获取网关当前配置:\r\n{}", configInfo);
                routes = JsonUtils.json2list(configInfo, RouteDefinition.class);
            }else{
